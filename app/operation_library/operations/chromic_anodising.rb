...
module OperationLibrary
  class AnodisingChromic
    def self.operations
      [
        # Chromic Acid Anodise Process 1 - High voltage variant
        Operation.new(
          id: 'CAA_40_50V_40MIN',
          alloys: ['general', 'aluminium', '6000_series', '7075', '2024'],
          process_type: 'chromic_anodising',
          anodic_classes: ['type_1'], # Chromic is Type I
          target_thickness: 2.5, # Typical chromic thickness
          vat_numbers: [10],
        ...
        # Chromic Acid Anodise Process 2 - Standard voltage variant
        Operation.new(
          id: 'CAA_22V_37MIN',
          alloys: ['general', 'aluminium', '6000_series', '7075', '2024'],
          process_type: 'chromic_anodising',
