    ...
    def self.operations
      [
        ...
        Operation.new(
          ...
          operation_text: '**Final inspection** - Check 100% of qty for uniform film appearance, if qty wrong pls detail here ___ and inform an A stampholder. **Check for Foreign Object Debris (FOD).'
        )
      ]
    end
