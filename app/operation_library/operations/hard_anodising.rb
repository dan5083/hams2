...
module OperationLibrary
  class AnodisingHard
    ...
    #
    # Hard anodise ramps read every 5 minutes for the length of the cycle -
    # the shape the old baked-in "**OCV Monitoring:**" text block drew as
    # ___V blanks - derived from the op text's "over N minutes".
    #
