...
class ReleaseNotesController < ApplicationController
  ...
  def create
    ...
    # Paperless aero/defence WOs record thickness in-line on the process
    # record; the model snapshots it at create. Only form-captured records
    # are parsed here.
    if thickness_measurements_provided? && !@release_note.inline_thickness_record?
